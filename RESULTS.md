...
![](img/chart-fetch-ratio.png) -- TODO херня какая-то
![](img/chart-image-size.png)

### Замечания

- конвертированные в eStargz образы на 3–8% тяжелее оригиналов из-за пофайлового сжатия. Это следует учитывать при оценке реального выигрыша в production-сценарии -- TODO-исправить график и проверить цифры
